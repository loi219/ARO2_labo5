...
\lstinputlisting[caption=main.S,label=et1a]{../labo5/mains/mainEt1.S}
...
\subsubsection{Programme fourni}
\lstinputlisting[caption=main.S,label=et1a]{../labo5/mains/mainEt2.S}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.2\textwidth]{src/ET2.png}
...
\lstinputlisting[caption=main.S,label=et1a]{../labo5/mains/mainEt2Mod.S}
...
\end{figure}
Pour la légende des couleurs, voir la Figure \ref{fig:et2_pic}.
